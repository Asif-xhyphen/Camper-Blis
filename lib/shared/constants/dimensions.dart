/// Design system dimensions following the specification
class Dimensions {
  // Spacing from design spec
  static const double spaceXS = 4.0; // xs
  static const double spaceS = 8.0; // sm
  static const double spaceM = 16.0; // md
  static const double spaceL = 24.0; // lg
  static const double spaceXL = 32.0; // xl
  static const double spaceXXL = 48.0; // xxl

  // Padding values (using spacing values)
  ...
  // Margin values (using spacing values)
  ...
  static const double radiusS = 8.0; // small
  static const double radiusM = 12.0; // medium
  static const double radiusL = 16.0; // large
  static const double radiusXL = 24.0; // xl
  static const double radiusXS = 4.0; // extra small for chips

  // Legacy radius mappings for compatibility
