...
class _$CampsiteImpl extends _Campsite {
  ...
  @override
  String toString() {
    return 'Campsite(id: $id, label: $label, geoLocation: $geoLocation, createdAt: $createdAt, isCloseToWater: $isCloseToWater, isCampFireAllowed: $isCampFireAllowed, hostLanguages: $hostLanguages, pricePerNight: $pricePerNight, photo: $photo, suitableFor: $suitableFor)';
  }
