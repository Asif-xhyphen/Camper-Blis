...
final availableCountriesProvider = AutoDisposeProvider<List<String>>.internal(
  availableCountries,
  name: r'availableCountriesProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$availableCountriesHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef AvailableCountriesRef = AutoDisposeProviderRef<List<String>>;
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef AvailableLanguagesRef = AutoDisposeProviderRef<List<String>>;
...
final languageDisplayNamesProvider =
    AutoDisposeProvider<Map<String, String>>.internal(
      ...
      name: r'languageDisplayNamesProvider',
      debugGetCreateSourceHash:
          const bool.fromEnvironment('dart.vm.product')
              ? null
              : _$languageDisplayNamesHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef PriceRangeBoundsRef =
    AutoDisposeProviderRef<({double min, double max})>;
String _$filterControllerHash() => r'65bc99be98bd0f6969b8a54f6d22f83a012cd23e';

/// See also [FilterController].
@ProviderFor(FilterController)
final filterControllerProvider =
    AutoDisposeNotifierProvider<FilterController, FilterCriteria>.internal(
...
typedef _$FilterController = AutoDisposeNotifier<FilterCriteria>;
